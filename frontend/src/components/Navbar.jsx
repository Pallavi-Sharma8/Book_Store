    ...
    >
      <div className="navbar  shadow-sm">
        <div className="navbar-start">
          ...
          <a className="text-xl md:text-2xl fomt-bold cursor-pointer">
            Book store
          </a>
        </div>
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block  dark:bg-slate-900">
            <label className="px-3 py-2 border rounded-md flex items-center gap-2">
              ...
              <input type="search" className="grow outline-none rounded-md px-1 dark:bg-slate-900 dark:text-white" placeholder="Search" />
            </label>
          </div>
